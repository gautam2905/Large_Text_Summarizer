...
def GUI():
    ...
    submit_button = Button(input_frame, text='Submit Text', command=lambda:[submit_text(), window.destroy], font=('Arial', 12))
    ...
    # File upload section
    upload_button = Button(file_frame, text="Upload File", command=lambda:[upload_file(), window.destroy], font=('Arial', 12))
